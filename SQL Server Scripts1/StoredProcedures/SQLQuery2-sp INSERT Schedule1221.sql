...
BEGIN
	...
	DECLARE @lesson_number		AS	TINYINT	=	(SELECT COUNT(lesson_id) FROM Schedule WHERE discipline=@discipline AND [group]=@group);---------Íóæíî ó÷èòûâàòü ïðîâåäåííûå çàíÿòèÿ ïî âûñòàâëÿåìîé äèñöèïëèíå
	PRINT @lesson_number;
